      ...
      <div className="max-w-3xl mx-auto space-y-8 relative z-10">
        ...
        <Card className="rounded-[2.5rem] p-8 sm:p-10 border-border bg-muted/5 space-y-6 text-xs text-muted-foreground leading-relaxed font-semibold">
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-foreground uppercase tracking-wider">1. General Educational Purpose</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-foreground uppercase tracking-wider">2. Accuracy and Delays of Market Data</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-foreground uppercase tracking-wider">3. AI Chat and News Summaries Limitation</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-foreground uppercase tracking-wider">4. Assumption of Risk</h2>
            <p>
