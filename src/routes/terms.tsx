      ...
      <div className="max-w-3xl mx-auto space-y-8 relative z-10">
        ...
        <Card className="rounded-[2.5rem] p-8 sm:p-10 border-border bg-muted/5 space-y-6 text-xs text-muted-foreground leading-relaxed font-semibold">
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-white uppercase tracking-wider">1. Agreement to Terms</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-white uppercase tracking-wider">2. Account Registration and Security</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-white uppercase tracking-wider">3. Permitted Platform Usage</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-white uppercase tracking-wider">4. Simulated Paper Trading</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-white uppercase tracking-wider">5. Intellectual Property</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-white uppercase tracking-wider">6. Termination Rights</h2>
            <p>
