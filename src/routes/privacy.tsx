      ...
      <div className="max-w-3xl mx-auto space-y-8 relative z-10">
        ...
        <Card className="rounded-[2.5rem] p-8 sm:p-10 border-border bg-muted/5 space-y-6 text-xs text-muted-foreground leading-relaxed font-semibold">
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-foreground uppercase tracking-wider">1. Scope and Consent</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-foreground uppercase tracking-wider">2. Information Collection</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-foreground uppercase tracking-wider">3. Caching and Cookie Usage</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-foreground uppercase tracking-wider">4. Third-Party API Services</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-foreground uppercase tracking-wider">5. Security Standards</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-black text-foreground uppercase tracking-wider">6. Contact Inquiries</h2>
            <p>
              For data access queries, compliance requests, or deletion tickets, please email our operations desk at: <a href="mailto:privacy@equinox.tech" className="text-foreground hover:underline">privacy@equinox.tech</a>.
            </p>
          </div>
